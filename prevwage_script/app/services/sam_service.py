        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    # fallback to just county base name if SAM omits "County"
            ...
            # CONSTRUCTION = hardcoded Building
            ...
            # Return the first candidate for now; validation happens later
